...
namespace Ejercicio2.Persistence
{
    public class DBBroker
    {
        private static DBBroker _instancia;
        private static MySql.Data.MySqlClient.MySqlConnection conexion;
        private const String cadenaConexion = "server=localhost;database=jugador;uid=root;pwd=root"; // mi usuario y contraseña son root y la bbdd es jugador
