...
namespace DataGridPersonas25_26.domain
{
    internal class Persona
    {
        ...
        private int edad;
        private DateTime fecha_incorporacion;
        ...
        public Persona(int id, string nombre, string apellido, int edad, DateTime fecha_incorporacion)
        {
            pm = new PersonaPersistance();
            this.id = id;
            this.nombre = nombre;
        ...
        public DateTime Fecha { get => fecha_incorporacion; set => fecha_incorporacion = value; }
